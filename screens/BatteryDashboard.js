...
const BatteryDashboard = ({navigation}) => {
  ...
  return (
    ...
    uri="https://svgshare.com/i/10gf.svg"
      ...
      <View>
            <TouchableOpacity className="bg-pink-500  focus:ring-4 focus:outline-none focus:ring-pink-700 dark:focus:ring-pink-800 font-extrabold rounded-3xl  px-10 py-2.5 text-center me-2 mb-2 mx-11 mt-2 justify-center" onPress={()=> navigation.navigate('PABattery')}><Text className="text-white text-lg">Perform ML Battery Analysis</Text></TouchableOpacity>
            <TouchableOpacity className="bg-orange-500  focus:ring-4 focus:outline-none focus:ring-orange-700 dark:focus:ring-orange-800 font-extrabold rounded-3xl  px-16 py-2.5 text-center me-2 mb-2 mx-11 mt-2 justify-center" onPress={()=> {Linking.openURL('https://main--comfy-griffin-891662.netlify.app/')}}><Text className="text-white text-lg">AR Thermal Mapping</Text></TouchableOpacity>
      </View>
      <View className="my-1 mx-1 w-48 h-48 bg-slate-200 border border-slate-200 rounded-3xl">
        ...
        <HumidChart progress={item.batteryPercent} fullrange={100} status="No maintenance required" />
      </View>
